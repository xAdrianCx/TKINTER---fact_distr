...
def generate():
	...
	if excel_path == "":
		messagebox.showerror("Error!", "Trebuie sa alegeti un fisier excel.")
...
year_label = Label(root, text="Selectati anul:", font=("Times New Roman", 12))
...
month_label = Label(root, text="Selectati luna:", font=("Times New Roman", 12))
...
input_file_path_label = Label(root, text="Selectati fisierul de import:", font=("Times New Roman", 12))
...
export_file_path_label = Label(root, text="Selectati directorul de export:", font=("Times New Roman", 12))
...
# Create start button.
start_button = Button(root, text="Generare facturi", font=("Times New Roman", 12), command=generate)
